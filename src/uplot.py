...
# dsmc = np.loadtxt('plots/dsmc.txt')
# dsmcT = np.loadtxt('plots/dsmcT.txt')
# dsmc_hard = np.loadtxt('plots/dsmc_hard.txt')
# dsmcT_hard = np.loadtxt('plots/dsmcT_hard.txt')
# dsmc_vhs = np.loadtxt('plots/dsmc_vhs.txt')
# dsmcT_vhs = np.loadtxt('plots/dsmcT_vhs.txt')
clarke_n = np.loadtxt('plots/clarkemach9n.npy')
clarke_T = np.loadtxt('plots/clarkemach9T.npy')
clarke_Tx = np.loadtxt('plots/clarkemach9Tx.npy')


alsmeyer_205 = np.loadtxt('plots/alsmeyer_205.txt')
